...
```
阶段一（Week 1-2）    阶段二（Week 3）      阶段三（Week 4-5）     阶段四（Week 6-7）
┌───────────────┐    ┌───────────────┐     ┌───────────────┐     ┌───────────────┐
│ 创建 IP 资产  │ →  │ 扩展特征库    │  →  │ 训练 LoRA     │  →  │ 质量评估      │
│ - 基础信息    │    │ - 服装库      │     │ - 数据集准备  │     │ - 测试图片    │
│ - 参考图      │    │ - 表情库      │     │ - 批量标注    │     │ - 一致性评分  │
│ - 多视图      │    │ - 动作库      │     │ - Caption生成 │     │ - 质量报告    │
└───────────────┘    └───────────────┘     └───────────────┘     └───────────────┘
                                                                          ↓
                                                               阶段五（Week 8）
                                                          ┌───────────────┐
...
| 阶段 | 时间 | 主要任务 | 里程碑 |
|------|------|----------|--------|
| 阶段一 | Week 1-2 | IP 资产管理（多视图 + 特征库） | ✅ IP 资产可用 |
| 阶段二 | Week 3 | 批量标注与 Caption 生成 | ✅ 数据集准备完成 |
| 阶段三 | Week 4-5 | Kohya 训练集成 | ✅ 训练可用 |
| 阶段四 | Week 6-7 | 质量评估体系 | ✅ 评估完成 |
| 阶段五 | Week 8 | IP-Adapter 增强 | ✅ 增强完成 |
| 阶段六 | Week 9 | 集成测试与优化 | ✅ 项目完成 |
